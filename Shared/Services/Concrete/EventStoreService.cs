...
namespace Shared.Services.Concrete
{
    public class EventStoreService : IEventStoreService
    {
        ...
        public async Task AppendToStreamAsync(string streamName, IEnumerable<EventData> eventData) => await Client.AppendToStreamAsync(streamName: streamName, eventData: eventData, expectedState: StreamState.Any);
